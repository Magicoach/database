DELIMITER $$
CREATE PROCEDURE `mc_ranking_sprints`(IN id_user int, IN date_start datetime, IN date_end datetime, IN order_by varchar(255)) 
 SQL SECURITY DEFINER  CONTAINS SQL BEGIN

  -- CALL mc_ranking_sprints(10350, '2014.01.01 10:00:00', '2017.01.01 10:00:00', 'max');
